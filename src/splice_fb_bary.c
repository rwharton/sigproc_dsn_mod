/*
  ...
  Modified        (Feb 2017) Aaron B. Pearlman (aaron.b.pearlman@caltech.edu)
                             - Modified to combine multiple filterbank files with the correct header format.
*/
#include <stdio.h>
#include <stdlib.h>
#include <math.h>
...
main (int argc, char **argv)
{
  ...
  for (i=0; i<nfiles; i++) {
    ...
    // Added by Aaron
    fprintf(stderr, "splicing file #%d... (%f MHz)\n", i, frch1[i]);
  }
